...
> Screenshots are still WIP, every stuff below this part isn't updated yet to reflect the shown screenshot. this message will be deleted in the future.
...
### 🖱️ App Themes
#### Main
- [YASB](https://github.com/amnweb/yasb) - [Config](./Apps/YASB/config.yaml) and [Styles](./Apps/YASB/styles.css)
- [GlazeWM](https://github.com/glzr-io/glazewm) - [Config](./Apps/GlazeWM/config.yaml)
- [Tacky-borders](https://github.com/lukeyou05/tacky-borders) - [Config](./Apps/Tacky-borders/config.yaml)
- [Flow Launcher](https://github.com/flow-launcher/flow.launcher) - [NodoCha Theme](./Apps/Flow%20Launcher/Theme_Nodocha.xaml) and [Modified Win11Light XAML](./Apps/Flow%20Launcher/Win11Light.xaml)
